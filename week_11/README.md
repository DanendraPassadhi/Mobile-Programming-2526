...
## Tugas Praktikum 7: <br> `BLoC Pattern`

> **Soal 13** <br>
> Jelaskan maksud praktikum ini ! Dimanakah letak konsep pola BLoC-nya ?

↪ Maksud dari praktikum ini adalah untuk mengimplementasikan Pola BLoC 
(Business Logic Component) yang sederhana menggunakan `Dart Streams` dan 
`StreamController` untuk memisahkan logika bisnis (menghasilkan angka acak) 
dari UI (menampilkan angka). <br>
↪ Konsep Pola BLoC (Business Logic Component) terletak pada pemisahan antara Logika Bisnis dan UI melalui penggunaan Streams.

> Capture hasil praktikum Anda berupa GIF dan lampirkan di README.

<img src="./image/p7-1.gif" alt="Prototype GIF" width="200" /><br>
